...
You would need to call `add_friendship()` 500 times. This is because you need 100 users * 10 friends = 1000 total friends, but since each friendship contains two people, you need half as many friendships as you do total friends, and 1000 total friends / 2 friends per friendship = 500 friendships.
